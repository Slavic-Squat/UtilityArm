...
namespace IngameScript
{
    partial class Program
    {
        ...
        public static readonly ArmControlMode[] ArmControlModeCycles = new ArmControlMode[] { ArmControlMode.Translate, ArmControlMode.Rotate, ArmControlMode.Pose };
        ...
        public static string GetName(ArmControlMode mode)
        {
            switch (mode)
            {
